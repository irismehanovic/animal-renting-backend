package com.animalrenting.filter;
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    private final AnimalUserDetailsService animalUserDetailsService;
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith(BEARER_STRING)) {
            ...
            if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                SimpleUser simpleUser = animalUserDetailsService.getUserByUsername(username);
